...
if ($stmt->affected_rows > 0) {
    echo "<script>alert('Expense updated successfully!'); window.location.href='view_expense.php';</script>";
} else {
    echo "<script>alert('No changes made or invalid ID.'); window.location.href='view_expense.php';</script>";
}
?>
